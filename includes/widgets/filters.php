...
<form class="" action="search.php" method="post">
  ...
  <input type="text" name="min_price" class="price-range" placeholder="Min price $" value="<?=$min_price;?>">
  To
  <input type="text" name="max_price" class="price-range" placeholder="Max price $" value="<?=$max_price;?>"><br><br>
