  ...
  if($_POST) {
    ...
    if($photoCount > 0) {
      for($i = 0; $i < $photoCount; $i++) {
           ...
           $dbpath .= '/clothes/img/products/'.$uploadName;
          if($mimeType != 'image') {
      ...
      <div class="form-group col-md-6">
        <?php if($saved_image != '') : ?>
          ...
          <?php foreach($images as $image) : ?>
            <div class="saved-image com-md-4"><img src="<?=$image; ?>" alt=""><br>
        ...
        <input type="file" name="photo[]" id="photo" value="" class="form-control" multiple>
      <?php endif; ?>
      </div>
      <div class="form-group col-md-6">
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <?php for($i=1; $i <= 12 ;$i++) : ?>
                ...
                <div class="form-group col-md-2">
                  <label for="treshold<?=$i;?>">Treshold:</label>
                  <input type="number" name="treshold<?=$i; ?>" id="treshold<?=$i; ?>" value="<?=((!empty($tArray[$i-1]))?$tArray[$i-1] :''); ?>" min="0" class="form-control">
                </div>
              <?php endfor; ?>
            </div>
          </div>
      ...
      ?>
        <tr>
          ...
          <td><a href="products.php?featured=<?=(($product['featured'] == 0)?'1':'0'); ?>&id=<?=$product['id']; ?>" class="btn btn-xs btn-default">
              ...
              </a><?=(($product['featured'] == 1))?'Featured Product':'' ; ?></a></td>
          <td>0</td>
        </tr>
      <?php endwhile; ?>
    </tbody>
