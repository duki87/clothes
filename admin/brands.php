<?php
  ...
  if(isset ($_POST['add_submit'])) {
    ...
    if($count>0) {
      $errors[] .= $brand.' already exist. Please choose another one.';
    }
    //Display errors
    if(!empty($errors)) {
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="brands.php?delete=<?php echo $brand['id']; ?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-remove"></td>
      </tr>
    <?php endwhile; ?>
    </tbody>
