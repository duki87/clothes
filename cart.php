...
<div class="col-md-12">
  <div class="row">
          ...
          <?php
            foreach($items as $item) {
              ...
              <tr>
                ...
                <td>
                    <button type="button" name="button" onclick="update_cart('removeone','<?=$product['id']; ?>','<?=$item['size']; ?>');" class="btn btn-xs btn-default">-</button>
                      <?=$item['quantity'];?>
                      <?php if($item['quantity'] < $available) : ?>
                    <button type="button" name="button" onclick="update_cart('addone','<?=$product['id']; ?>','<?=$item['size']; ?>');" class="btn btn-xs btn-default">+</button>
                      <?php else : ?>
    ...
    <!-- Modal -->
    <div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModalModalLabel">
...
<script>
  ...
  jQuery.ajax({
    url : '/clothes/admin/parsers/check_address.php',
    method : 'POST',
    data : data,
    success : function(data) {
      ...
      if(data == 'passed') {
        ...
        jQuery('#checkoutModalLabel').html("Enter your credit card details");
      }
    },
